...
export default function UpperContent() {
    ...
    return (
        <div className="flex ">
            {location.pathname === "/" && <div className="max-w-[35%] mx-20 md:-mt-32 ml-28 xl:-mt-52">
                <div
                ...
                >
                        ...
                        <Link to="/snakes-info" className=" inline-block text-center bg-green-800 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded mt-6 shadow-lg transition-colors duration-300 drop-shadow-md"
                        >
